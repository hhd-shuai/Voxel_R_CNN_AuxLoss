...
class NeighborVoxelSAModuleMSG(nn.Module):
    ...
    def __init__(self, *, query_ranges: List[List[int]], radii: List[float],  #query_ranges: [[2, 2, 2], [4, 4, 4]]  ,, radii: [0.4, 0.8]
        nsamples: List[int], mlps: List[List[int]], use_xyz: bool = True, pool_method='max_pool'):    # nsamples: [16, 16], mpls: [[64, 32, 32], [64, 32, 32]]
        """
        Args:
